...
from app.passage_retrieval.DPR.dpr.models.biencoder import BiEncoder, BiEncoderNllLoss, BiEncoderBatch
...
from app.passage_retrieval.DPR.dpr.utils.dist_utils import all_gather_list
...
#             )
    ...
    def _train_epoch(
        ...
        ),total=train_data_iterator.total_data_len()):
